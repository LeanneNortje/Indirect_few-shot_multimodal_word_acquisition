...
def spawn_training(rank, world_size, image_base, args):
    ...
    train_dataset = ImageAudioDatawithMasks(image_base, args["data_train"], args, rank)
    ...
    if rank == 0: 
        ...
        validation_loader = torch.utils.data.DataLoader(
            ImageAudioDatawithMasksVal(image_base, args["data_val"], args, rank),
    ...
    for epoch in np.arange(start_epoch, args["n_epochs"] + 1):
        ...
        # break
            ...
            if rank == 0 and (i % 2000 == 0 or i == len(train_loader)):
